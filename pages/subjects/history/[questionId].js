...
const Question = ({ question }) => {
	return <QuestionPage question={question} pageColor="history" />;
};

export default Question;

const getPostBySlug = async (questionId) => {
	return await getQuestionsFromSubject("history").then((questions) =>
...
export async function getStaticPaths() {
	const questions = await getQuestionsFromSubject("history");
