...
const Question = ({ question }) => {
	return <QuestionPage question={question} pageColor="math" />;
};

export default Question;

const getPostBySlug = async (questionId) => {
	return await getQuestionsFromSubject("math").then((questions) =>
...
export async function getStaticPaths() {
	const questions = await getQuestionsFromSubject("math");
